...
"""
The Baichuan Model transformer with a sequence classification head on top (linear layer).

[`BaichuanForSequenceClassification`] uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.
...
# -------- 参考 LLaMa 的 modeling
# https://github.com/huggingface/transformers/blob/main/src/transformers/models/llama/modeling_llama.py#L785