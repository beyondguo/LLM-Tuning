...
WANDB_PROJECT=DCAI-ABSA-Baichuan2-chat CUDA_VISIBLE_DEVICES=3 python baichuan2_lora_tuning.py \
    ...
    --remove_unused_columns false \
    --logging_steps 25 \
    --output_dir weights/absa_instruction-first_d1_train-1000-Baichuan2-7B-Chat \
    --report_to wandb \
    --run_name absa_instruction-first_d1_train-1000_gby1030
...
WANDB_PROJECT=DCAI-ABSA-Baichuan2-chat CUDA_VISIBLE_DEVICES=3 python baichuan2_lora_tuning.py \
    ...
    --remove_unused_columns false \
    --logging_steps 25 \
    --output_dir weights/absa_instruction-first_d2_train-1000-Baichuan2-7B-Chat \
    --report_to wandb \
    --run_name absa_instruction-first_d2_train-1000_gby1030
